...
<ul>
  <li>🎨 Bars, Circular, Ripple, Galaxy modes</li>
  <li>🎤 Synced lyrics with LRC timestamps</li>
  <li>🧠 Mood-based lyrics generation</li>
  <li>🌍 Multi-language support (6 languages)</li>
  <li>🎧 File upload with real-time analysis</li>
</ul>
...
<ul>
  <li>💰 Cash &amp; bank HUD with compass direction</li>
  <li>🎒 Inventory system with item quality tiers</li>
  <li>📱 In-game smartphone with 8 functional apps</li>
  <li>🚗 Vehicle speedometer with gear and fuel</li>
  <li>🔔 Animated notification system</li>
</ul>
...
<ul>
  <li>🔍 Automated threat level classification</li>
...
<ul>
  <li>🎯 5 ranking tiers from Novinec to Mojster</li>
  <li>⚡ Streak multiplier system (up to 5×)</li>
  <li>⏱ 15-second timer with time bonus scoring</li>
  <li>🕹️ Retro-neon arcade aesthetic</li>
</ul>
